...
fdsa
{$ENDIF}
  uses madExcept, madLinkDisAsm, madListHardware, madListProcesses, madListModules, SysUtils, Classes, msProgram, msGlobals, msUtils, msResources, DateUtils, JclAnsiStrings, makestudio_TLB;
