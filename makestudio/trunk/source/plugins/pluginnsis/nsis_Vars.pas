...
resourcestring
  struPluginName = 'NSIS Setup Plugin';
  struNSISCommandName = 'NSIS Project';
  struPluginAuthor = 'Burkhard Schranz (burkhard.schranz@optimeas.de)';
  struPluginHint = 'Plugin for NSIS Setup Projects';
  stCategory = 'Installation';

resourcestring
  strNSISProject = 'NSIS <%s>';
  strProjectFile='Project file';
  strOutputfile='Output file';
  strOptions='Options';
  strPreviewText = 'Output file: "%s"' + #10#13 +
                   'Options: "%s"';
  strExecutingProject = 'Executing NSIS Project...';

  strErrorCompilerNotFound = 'NSIS (makensis.exe) Compiler not found!';
