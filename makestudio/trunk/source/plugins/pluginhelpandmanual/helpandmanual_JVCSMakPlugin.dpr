...
library helpandmanual_MakeStudioPlugin;
...
uses
  ...
  helpandmanual_Actions in 'helpandmanual_Actions.pas' {Form3},
  helpandmanual_Actiontest in 'helpandmanual_Actiontest.pas' {Form2},
  helpandmanual_EditHelpandmanualModule in 'helpandmanual_EditHelpandmanualModule.pas' {FormHelpandmanualModuleEdit},
  helpandmanual_Module in 'helpandmanual_Module.pas';
...
begin
  ...
  try
    Form3.Free;
    HelpandmanualCommandCallback.Free;
  except
  end;
end;
