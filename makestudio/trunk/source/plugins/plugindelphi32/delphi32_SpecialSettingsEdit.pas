...
-----------------------------------------------------------------------------*)
unit delphi32_SpecialSettingsEdit;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls, delphi32_SpecialSettingsCommand, delphi32_Vars;

type
  TFormEditSpecialSettingsParams = class(TForm)
    Button1: TButton;
    Button2: TButton;
...
procedure TFormEditSpecialSettingsParams.FormCreate(Sender: TObject);
var i:Integer;
    k:TGetVarOperationType;
begin
  cbVars.Clear;
  ...
  for k:=otBPLDir to High( stGetVarActions) do
    cbOperation.Items.Add( stGetVarActions[ k]);
end;
