...
-----------------------------------------------------------------------------*)
library jedimakeplugin_Example_D2006;
...
uses
  ...
  Forms,
  ActiveX,
  jedimakeplugin_Actions in 'jedimakeplugin_Actions.pas' {FormActions},
  jedimakeplugin_Actiontest in 'jedimakeplugin_Actiontest.pas' {FormActionTest},
  jedimakeplugin_ExampleCommand_Edit in 'jedimakeplugin_ExampleCommand_Edit.pas' {FormEditExample_commandParams},
  jedimakeplugin_ExampleCommand in 'jedimakeplugin_ExampleCommand.pas',
  jedimakeplugin_Vars in 'jedimakeplugin_Vars.pas';
...
begin
  ...
  begin
    try
      ...
      //--- add actions --------------------------------------------------------
      GetPictureFromImageList(FormActions.ImageList1, FormActions.acTestaction2006.ImageIndex, P);
      ...
      MakeStudio.AddMenuAction(FormActions.acTestaction2006.Name,
                             'Examples\' + FormActions.acTestaction2006.Caption,
                             FormActions.acTestaction2006.Hint,
                             P,
      ...
      MakeStudio.AddCommandType(stSampleCommandCaption, '', stCategory, P, 'txt', -1,
...
begin
  ...
  try
    ...
    PluginExample_commandCallback.Free;
  except
  end;
end;
