...
type
  TFormActions = class(TForm, IActionCallback)
    ...
    acTestaction2005: TAction;
    procedure acTestaction2005Execute(Sender: TObject);
  private
...
procedure TFormActions.acTestaction2005Execute(Sender: TObject);
begin
