...
-----------------------------------------------------------------------------*)
library jedimakeplugin_Example_D7;
...
begin
  ...
  begin
    try
      ...
      //--- add actions --------------------------------------------------------
      GetPictureFromImageList(FormActions.ImageList1, FormActions.acTestactionD7.ImageIndex, P);
      ...
      MakeStudio.AddMenuAction(FormActions.acTestactionD7.Name,
                             'Examples\' + FormActions.acTestactionD7.Caption,
                             FormActions.acTestactionD7.Hint,
                             P,
