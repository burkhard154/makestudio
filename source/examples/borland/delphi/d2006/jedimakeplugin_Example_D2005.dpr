...
-----------------------------------------------------------------------------*)
library jedimakeplugin_Example_D2005;
...
begin
  ...
  begin
    try
      ...
      //--- add actions --------------------------------------------------------
      GetPictureFromImageList(FormActions.ImageList1, FormActions.acTestaction2005.ImageIndex, P);
      ...
      MakeStudio.AddMenuAction(FormActions.acTestaction2005.Name,
                             'Examples\' + FormActions.acTestaction2005.Caption,
                             FormActions.acTestaction2005.Hint,
                             P,
