...
uses
  ...
  Forms,
  ActiveX,
  CVS_Actions in 'CVS_Actions.pas' {FormActions},
  CVS_SynchronizeEdit in 'CVS_SynchronizeEdit.pas' {FormEditSynchronizeParams},
  CVS_SynchronizeCommand in 'CVS_SynchronizeCommand.pas',
  CVS_Vars in 'CVS_Vars.pas';
...
begin
  ...
  try
    ...
    PluginSynchronizeCallback.Free;
  except
  end;
end;
