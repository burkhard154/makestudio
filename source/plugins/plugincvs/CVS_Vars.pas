...
resourcestring
  struPluginName = 'CVS Plugin';
  struPluginAuthor = 'Burkhard Schranz (burkhard.schranz@optimeas.de)';
  struPluginHint = 'Plugin for CVS';
  stCategory = 'Version Control';
  stSynchronizeCommand = 'CVS Synchronize';
  stSynchronizeCommandHint = 'Synchronize with a CVS Repository';
