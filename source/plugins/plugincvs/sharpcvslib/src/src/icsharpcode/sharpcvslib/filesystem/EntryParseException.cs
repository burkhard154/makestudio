...
namespace ICSharpCode.SharpCvsLib.FileSystem {
    ...
    [Obsolete("Use ICSharpCode.SharpCvsLib.Exceptions.EntryParseException")]
	public class EntryParseException : ICSharpCode.SharpCvsLib.Exceptions.EntryParseException{
        /// <summary>
