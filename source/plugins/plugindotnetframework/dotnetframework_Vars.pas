...
resourcestring
  struPluginName = 'Dot Net Framework';
  struPluginAuthor = 'Burkhard Schranz (burkhard.schranz@optimeas.de)';
  struPluginHint = 'Dot Net Framework Utilities';
  stCategory = '.Net Framework';
  stCommandCaption = 'TlbImp';
  stCommandHint = 'Calls the Framework type library importer tool';
