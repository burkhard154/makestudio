...
-----------------------------------------------------------------------------*)
unit delphi32_brcc32CommandEdit;
...
type
  TFormEditbrcc32Command = class(TForm)
    Label1: TLabel;
    Button1: TButton;
    Button2: TButton;
...
var
  FormEditbrcc32Command: TFormEditbrcc32Command;

implementation

{$R *.dfm}

procedure TFormEditbrcc32Command.btEditClick(Sender: TObject);
begin
//
end;
