...
uses
  ...
  Forms,
  ActiveX,
  mytestplg01_Actions in 'mytestplg01_Actions.pas' {FormActions},
  mytestplg01_Actiontest in 'mytestplg01_Actiontest.pas' {FormActionTest},
  mytestplg01_Edit in 'mytestplg01_Edit.pas' {FormEditParams},
  mytestplg01_Module in 'mytestplg01_Module.pas',
  mytestplg01_Vars in 'mytestplg01_Vars.pas';
...
begin
  ...
  begin
    try
      ...
      //Name=testcommand01; Hint, Category
...
begin
  ...
  try
    ...
    Plugintestcommand01Callback.Free;
  except
  end;
end;
